...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `O and L last Valentines day : <b>${days}</b> días<br>` +
      `Si me dices que si.. faltarian para estar san valentin juntos : <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
